...
test_that("read_footer throws an error if incorrect sheetname given", {
  expect_error(TFootr::read_footer("C:/Users/u066227/TFootr/inst/extdata/titles_footers_sample.xls", sheetname = "header"), "Failed to read the sheet. Please check the file and sheet name.")
})
